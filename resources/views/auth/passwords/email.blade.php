            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
                        <div class="text-muted text-center mt-2 mb-3"><small>Resetar a senha</small></div>
                    </div>
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        @endif
                        {!! Form::model(['route' => 'password.email', 'method' => 'post']) !!}
                        @csrf
                        ...
                        <div class="text-center">
                            {!! Form::submit(__('Enviar o link de redefinição de senha'), ['class' => 'btn btn-primary my-4']) !!}
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('register') }}" class="text-light"><small>{{ __('Criar nova conta') }}</small></a>
                    </div>
                </div>
            </div>
        </div>
